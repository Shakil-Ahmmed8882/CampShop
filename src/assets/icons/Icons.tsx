...
export const CheckCircle = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={`${className} size-6 text-primaryColor rounded-full`}
    >
      <path
        strokeLinecap="round"
...
export const Warning = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className={`${className} size-6 text-[red] rounded-full`}
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const CartIcon = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="size-6 text-[#cac8c8] smooth-transition hover:text-white cursor-pointer "
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const ClearIcons = ({ clickHandler }: { clickHandler: () => void }) => {
  return (
    <ClearOutlined
      ...
      title="clear"
      className="text-[20px] text-[#818181] smooth-transition hover:text-white cursor-pointer "
    />
  );
};
