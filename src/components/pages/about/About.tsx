...
const About = (): JSX.Element => {
  return (
    <Container>
      <div className="dark:bg-muted-foreground dark:text-background -mt-20">
  ...
  <div className="absolute inset-0 flex items-center justify-center mt-16">
    <div className="text-center">
      ...
      <Description className="px-3">Learn more about us. Our mission, team & future goals.</Description>
    </div>
  </div>
</header>
        <main>
...
const OurTeam = () => {
  return (
    <section className="  bg-[#18221431] rounded-lg">
      ...
      <div className="">
      <Title className="!text-2xl sm:!text-2xl text-center pb-8 lg:pb-16">Meet our Team</Title>
