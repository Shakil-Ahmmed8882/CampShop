...
const ConfirmDialog = ({handleDelete}): JSX.Element => {
  return (
    <AlertDialog>
      <AlertDialogTrigger>
    ...
    >
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={()=> handleDelete(false)}>Cancel</AlertDialogCancel>
          <AlertDialogAction className={"!bg-[red]"} onClick={()=> handleDelete(true)}>Delete</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  );
